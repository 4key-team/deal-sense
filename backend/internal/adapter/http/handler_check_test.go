...
func TestHandleCheckConnection(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h := handler.NewHandler(llm, nil, nil, nil, stubPrompt, stubPrompt, nil, testLogger, nil, nil, nil, nil, nil)
...
func TestResolveLang(t *testing.T) {
	...
	h := handler.NewHandler(llm, nil, p, nil, promptFn, promptFn, nil, testLogger, nil, nil, nil, nil, nil)

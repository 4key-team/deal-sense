...
func TestHandleAnalyzeTender(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := handler.NewHandler(tt.llm, nil, tt.parser, nil, stubPrompt, stubPrompt, nil, testLogger, nil, nil, nil, nil)
...
func TestHandleAnalyzeTender_FullResponse(t *testing.T) {
	...
	h := handler.NewHandler(llm, nil, p, nil, stubPrompt, stubPrompt, nil, testLogger, nil, nil, nil, nil)

...
const (
	...
	MsgHelp = "📚 Команды бота:\n\n" +
		...
		"   Пришлите команду, затем один или несколько файлов.\n" +
		"   Запустить — /go. Отменить — /cancel.\n\n" +
		"📝 /generate — генерация КП по шаблону.\n" +
		"   Форматы шаблона: DOCX (плейсхолдеры или генеративный),\n" +
		"   MD (smart+plain), ZIP с шаблоном внутри.\n" +
		"   Первый файл — шаблон. Следом можно прислать контекст\n" +
		"   (бриф, прошлые КП, прайс) — LLM их учтёт. Запустить — /go.\n\n" +
		"🚀 /go — запустить накопленные файлы (после /analyze или /generate).\n" +
		"❌ /cancel — отменить активный wizard (/profile / /llm / /analyze / /generate).\n\n" +
		"👤 /profile — текущий профиль компании.\n" +
		"   /profile edit — заполнить / обновить.\n" +
		"   /profile clear — удалить.\n\n" +
		"🤖 /llm — настройки LLM для этого чата.\n" +
